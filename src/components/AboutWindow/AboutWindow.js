            ...
            {activeBtn === 1 && (
                  <section className="about-section">
                    <div className="about-alert">
                        <p>
                            ❗Не використовуйте додаток як основне джерело оповіщення про
                    ...
                    <div className="about-info-bg">
                        <div className="about-info">
                            <h3>
                                <span>|</span>Як користуватися додатком
                            </h3>
                            <p>
                                Додаток надає зручний інтерфейс для перегляду інформації про
                    ...
                    <div className="about-info-bg">
                        ...
                        <div className="about-info faq-item">
                            <p onClick={() => toggleAnswer(0)}>
                                <strong>
                                    Чи можу я покладатися на дані додатку як на основне джерело?
                                </strong>
                                <span
                    ...
                    {openIndexes.includes(0) ? (
                        ...
                        <FaChevronDown/>
                            ...
                            {openIndexes.includes(0) && (
                                <p>
                                    Цей додаток надає інформацію на основі відкритих джерел і може
